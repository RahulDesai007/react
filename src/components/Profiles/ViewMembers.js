...
export default class ViewProfile extends Component {
    ...
    onClickHome = (item) => {
     ...
     //   this.setState({ errors });
            ...
            .then((responseJson) => {
                console.log("responseJson1234",responseJson);
                ...
                console.log("profileObj",responseJson.profileObj);
                ...
                if (message === 'Profile Not Built Yet' || message === 'Internal Server Error!' || message === 'invalid token') {
                    ...
                    this.props.navigation.navigate('HomePage', {token:token, profileObj:profileObj, growableObj:growableObj, date:date, time:time, member:member});
